...
#
# #
# export BAR_COLOR=0xff1e1e2e     # Deeper background
# export ITEM_BG_COLOR=0xff3c3e4f # Subtle selection background
# export ACCENT_COLOR=0xff89dceb  # Softer cyan, easier on the eyes
# #
# export BAR_COLOR=0xff282a36     # Dracula background
# export ITEM_BG_COLOR=0xff44475a # Dracula selection background
# export ACCENT_COLOR=0xff8be9fd  # Dracula cyan for accent
#
# -- Gray Scheme --
